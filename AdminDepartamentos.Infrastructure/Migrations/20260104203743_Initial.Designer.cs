...
namespace AdminDepartamentos.Infrastucture.Migrations
{
    ...
    [Migration("20260104203743_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdminDepartamentos.Infrastucture.Context.Entities.InquilinoEntity", b =>
                {
                    b.Property<int>("IdInquilino")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("UnidadHabitacionalIdUnidadHabitacional")
                        .HasColumnType("integer");

                    b.HasKey("IdInquilino");

                    b.HasIndex("UnidadHabitacionalIdUnidadHabitacional");

                    b.ToTable("Inquilinos");
                });

            modelBuilder.Entity("AdminDepartamentos.Infrastucture.Context.Entities.PagoEntity", b =>
                {
                    b.Property<int>("IdPago")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AdminDepartamentos.Domain.Entities.Pago", b =>
                {
                    b.HasOne("AdminDepartamentos.Domain.Entities.Inquilino", "Inquilino")
                        .WithOne("Pago")
                        .HasForeignKey("AdminDepartamentos.Domain.Entities.Pago", "IdInquilino")
            ...
            modelBuilder.Entity("AdminDepartamentos.Infrastucture.Context.Entities.InquilinoEntity", b =>
                {
                    b.HasOne("AdminDepartamentos.Domain.Entities.UnidadHabitacional", "UnidadHabitacional")
                        .WithMany()
                        .HasForeignKey("UnidadHabitacionalIdUnidadHabitacional");
            ...
            modelBuilder.Entity("AdminDepartamentos.Infrastucture.Context.Entities.PagoEntity", b =>
                {
                    b.HasOne("AdminDepartamentos.Infrastucture.Context.Entities.InquilinoEntity", "Inquilino")
                        .WithOne("Pago")
                        .HasForeignKey("AdminDepartamentos.Infrastucture.Context.Entities.PagoEntity", "IdInquilino")
